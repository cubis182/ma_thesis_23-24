...
let $sent := deh:read-sent-address('/proiel/caes-gal.xml|52689', $all-trees)
return ($sent/token[@id="797153"]/deh:return-descendants(.), $sent/token[@id="797153"]/deh:return-descendants-nonp(.))
